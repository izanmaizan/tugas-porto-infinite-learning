    ...
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        <div className="pb-8">
          ...
          <p className="py-6">Submit form berikut untuk mengirim email kepada saya.</p>
        </div>
        ...
        <div className=" flex justify-center items-center">
          <form
            ...
            name="contact"
            method="POST"
            action="mailto:izanmaizan@gmail.com"
          ...
          >
            ...
            <textarea
              name="message"
              placeholder="Masukkan pesan yang mau dikirimkan"
              rows="10"
              required
              className="p-2 bg-transparent border-2 rounded-md text-white focus:outline-none"
            ></textarea>
